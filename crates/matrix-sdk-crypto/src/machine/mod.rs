...
impl OlmMachineBuilder {
    ...
    /// Specify an [`X509Verifier`] which the `OlmMachine` should use to verify
    /// people's identities.
    #[cfg(feature = "experimental-x509-identity-verification")]
    ...
    /// Specify an [`X509Signer`] which the `OlmMachine` should use to sign
    /// our own identity.
    #[cfg(feature = "experimental-x509-identity-verification")]
